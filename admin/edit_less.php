                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">ฟอร์มเเก้ไขสัญญาเช่า</h6>
                        </div>
                        <div class="card-body">
                            <?php
                            ...
                            <form method="post" action="">
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="date" name="leases_date" value="<?=$data["leases_date"]?>" required
                                            class="form-control" id="inputEmail4">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="inputPassword4">วันสิ้นสุดสัญญา</label>
                                        <input type="date" value="<?=$data["expires_date"]?>" name="expires_date"
                                            required class="form-control" id="inputPassword4">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="inputAddress">ชื่อ-นามสกุล</label>
                                        <input type="text" value="<?=$data["r_name"]?>" name="r_name" required
                                            class="form-control">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="inputAddress">เลขที่บัตรประชาชน</label>
                                        <input type="text" value="<?=$data["r_idcard"]?>" name="r_idcard" required
                                            class="form-control">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="inputAddress">เบอร์โทรศัพท์</label>
                                        <input type="text" value="<?=$data["r_tel"]?>" name="r_tel" required
                                            class="form-control">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="inputAddress">อีเมล</label>
                                        <input type="email" value="<?=$data["r_email"]?>" name="r_email" required
                                            class="form-control">
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="inputAddress">ที่อยู่</label>
                                        <textarea class="form-control" name="r_add" required id=""
                                            rows="5"><?=$data["r_add"]?></textarea>
                                    </div>
                                    <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" value="<?=$data["l_c_e"]?>" name="l_c_e" required
                                            class="form-control" value="25">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="inputAddress">ค่าน้ำต่อหน่วย</label>
                                        <input type="text" value="<?=$data["l_c_w"]?>" name="l_c_w" required
                                ...
                                <button type="submit" name="editSubmit"
                                    class="btn btn-warning text-dark">เเก้ไข</button>
                            </form>
                            <?php
}
