                            ...
                            <form action="" method="post">
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" required name="room_id" class="form-control"
                                            placeholder="หมายเลขห้องห้ามซ้ำกัน เช่น a53 b59">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="inputAddress">มิเตอร์น้ำตั้งต้น</label>
                                        <input type="number" value="0" min="0" name="meters_water" required
                                            class="form-control">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="inputAddress">มิเตอร์ไฟตั้งต้น</label>
                                        <input type="number" value="0" min="0" name="meters_light" required
                                            class="form-control">
                                    </div>
                                    <div class="form-group col-md-12">
...
include_once "./configs/connectDB.php";
    ...
    while ($data = mysqli_fetch_assoc($result)) {?>
                                                <option value="<?=$data["room_tid"]?>"><?=$data["room_tname"]?></option>
                                                <?php
}
    ...
    ?>
            ...
            <?php
include_once "./configs/connectDB.php";
    if (isset($_POST["InsertRoomSubmit"])) {
        $sql = "INSERT INTO `room` (`room_id`, `room_status`, `meters_water`, `meters_light`, `room_tid`)
                VALUES ('" . $_POST["room_id"] . "', '0', '" . $_POST["meters_water"] . "',
                 '" . $_POST["meters_light"] . "', '" . $_POST["room_tid"] . "');";
